...
const StudentReportCardList = () => {
    ...
    const columns = [
        ...
        },
        {
            id: '9',
            name: 'Marks Total',
            selector: row => row.marksobtained,
            sortable: true,
            compact: true,
            width: "7rem",
            wrap: true,
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const response = await fetch('https://sikligarapi-fpe3b0bjfhgsadg5.centralindia-01.azurewebsites.net/api/v1/studentreportcardlist');
                //const response = await fetch('https://sikligarapi-fpe3b0bjfhgsadg5.centralindia-01.azurewebsites.net/api/v1/studentreportcardlist');
                setFetchData(false);
    ...
    function downloadCSV() {
        ...
        filename = 'Student_ReportCard_Data' + '(' + new Date().toLocaleDateString("IN") + ').csv';
