...
const StudentInstitutionEdit = () => {
    ...
    const fetchUserInfo = async () => {
        ...
        try {
            ...
            const response = await fetch(`https://sikligarapi-fpe3b0bjfhgsadg5.centralindia-01.azurewebsites.net/api/v1/getSingleStudentInst/${JSON.parse(searchParams.get('Id'))}`);
            if (!response.ok) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`https://sikligarapi-fpe3b0bjfhgsadg5.centralindia-01.azurewebsites.net/api/v1/updateBasicDetail/${id}`, {
                method: "PUT",
                headers: {
