...
const StudentFamilyEdit = () => {
    ...
    const fetchUserInfo = async () => {
        ...
        setloading(true);
        try {
            const response = await fetch(`https://sikligarapi-fpe3b0bjfhgsadg5.centralindia-01.azurewebsites.net/api/v1/getSingleStudentFamily/${JSON.parse(searchParams.get('Id'))}`);
            if (!response.ok) {
