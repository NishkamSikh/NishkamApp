...
const AreaSummary_State = () => {
    ...
    const columns = [
        ...
        { id:'3', name: 'Total', selector: row => row.Total, sortable: true, compact: true, width: "4rem", wrap: true, },
            ...
            {FetchData ?
                ...
                <div>
                    <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
                        <div>
                            <p className="font-bold text-orange-900 tracking-tight text-1xl">Area Summary - State wise</p>
                        </div>
                    </div>
