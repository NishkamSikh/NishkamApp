...
const DashBoardSummary = () => {
    ...
    const columns = [
        ...
        { name: 'State', selector: row => row.State, sortable: true, compact: true, width: "6rem", wrap: true, },
        { name: 'District', selector: row => row.District, sortable: true, compact: true, width: "5rem", wrap: true, },
        ...
        { name: 'Nur', selector: row => (<div>{row.Nur}</div>), sortable: false, compact: true, width: "2.8rem", wrap: true, },
        { name: 'LKG', selector: row => (<div>{row.LKG}</div>), sortable: false, compact: true, width: "2.8rem", wrap: true, },
        { name: 'I', selector: row => (<div>{row.I}</div>), sortable: false, compact: true, width: "2rem", wrap: true, },
        { name: 'II', selector: row => (<div>{row.II}</div>), sortable: false, compact: true, width: "2rem", wrap: true, },
        { name: 'III', selector: row => (<div>{row.III}</div>), sortable: false, compact: true, width: "2rem", wrap: true, },
        { name: 'IV', selector: row => (<div>{row.IV}</div>), sortable: false, compact: true, width: "2rem", wrap: true, },
        { name: 'V', selector: row => (<div>{row.V}</div>), sortable: false, compact: true, width: "2rem", wrap: true, },
        { name: 'VI', selector: row => (<div>{row.VI}</div>), sortable: false, compact: true, width: "2rem", wrap: true, },
        { name: 'VII', selector: row => (<div>{row.VII}</div>), sortable: false, compact: true, width: "2.5rem", wrap: true, },
        { name: 'VIII', selector: row => (<div>{row.VIII}</div>), sortable: false, compact: true, width: "2.5rem", wrap: true, },
        { name: 'IX', selector: row => (<div>{row.IX}</div>), sortable: false, compact: true, width: "2rem", wrap: true, },
        { name: 'X', selector: row => (<div>{row.X}</div>), sortable: false, compact: true, width: "2rem", wrap: true, },
        { name: 'XI', selector: row => (<div>{row.XI}</div>), sortable: false, compact: true, width: "2rem", wrap: true, },
        { name: 'XII', selector: row => (<div>{row.XII}</div>), sortable: false, compact: true, width: "2.5rem", wrap: true, },
        { name: '<5', selector: row => (<div>{row.A1_5}</div>), sortable: false, compact: true, width: "2.5rem", wrap: true, },
        ...
        { name: '16-20', selector: row => (<div>{row.A16_20}</div>), sortable: false, compact: true, width: "3.5rem", wrap: true, },
        { name: '21-25', selector: row => (<div>{row.A21_25}</div>), sortable: false, compact: true, width: "3.5rem", wrap: true, },
        { name: '25+', selector: row => (<div>{row.A25}</div>), sortable: false, compact: true, width: "3.5rem", wrap: true, },
