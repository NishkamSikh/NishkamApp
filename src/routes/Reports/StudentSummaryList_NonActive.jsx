...
//                const url = new URL('https://sikligarapi-fpe3b0bjfhgsadg5.centralindia-01.azurewebsites.net/api/v1/fetchAllStudentSummary?AcademicYear='+AcademicYear);
                   const url = new URL('https://sikligarapi-fpe3b0bjfhgsadg5.centralindia-01.azurewebsites.net/api/v1/fetchAllStudentSummary_NonActive?AcademicYear='+AcademicYear);
