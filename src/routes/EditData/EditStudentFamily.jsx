                ...
                loading
                    ...
                    <div className="mt-2 flex flex-col">
                        <h1 className="font-bold text-gray-900 tracking-tight sm:text-2xl">
                            Student Family Detail {studentCode}, {year}, {catgcode}
                        </h1>
                            ...
                            <div className="space-y-12">
                                <div className="border-b border-gray-900/10 pb-12">
                                    <div className="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                        ...
                                        <div className="sm:col-span-3">
                                            <label htmlFor="anyAssisstance" className="block text-sm font-medium leading-6 text-gray-900">
                                                Any Assisstance
                                            </label>
                                            <div className="mt-2">
                                                <select
                                        ...
                                        <div className="sm:col-span-3">
                                            <h5 className="font-bold text-gray-900 tracking-tight sm:text-xl">
                                                For Father
                                            </h5>
                                            <div >
                                                <div className="mt-1">
                                        ...
                                        <div className="sm:col-span-3">
                                            <h5 className="text-3xl font-bold text-gray-900 tracking-tight sm:text-xl">
                                                For Mother
                                            </h5>
                                                ...
                                                <div className="mt-2">
                                                    <div className="my-2">
                                                        ...
                                                        <input
                                                            ...
                                                            className='block w-full rounded-md border-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6' id="Mother_Education" placeholder='Mother Education' aria-describedby="Mother_Education" />
                                                ...
                                                <div className="mt-2">
                                                    <div className="my-2">
                                                        ...
                                                        <input
                                                            ...
                                                            className='block w-full rounded-md border-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6' id="M_Gross_Income" placeholder='Mother Gross Income' aria-describedby="M_Gross_Income" />
                                                    </div>
                                                </div>
                                                <div className="mt-2">
                                                    <div className="my-2">
                                                        ...
                                                        <input value={formData['M_Aadhar_No']}
                                                            ...
                                                            className='block w-full rounded-md border-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6' id="M_Aadhar_No" placeholder='Mother Aadhar Card Number' aria-describedby="M_Aadhar_No" />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="mt-2">
                                                    <div className="my-2">
                                                        ...
                                                        <input
                                                            ...
                                                            className='block w-full rounded-md border-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6' id="Gross_Income" placeholder='Guardian Gross Income' aria-describedby="Gross_Income" />
                                                    </div>
                                                </div>
                                                <div className="mt-2">
                                                    <div className="my-2">
...
export default EditStudentFamily