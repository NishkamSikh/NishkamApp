    ...
    const fetchUserInfo = async () => {
        ...
        try {
            ...
            if (data.data.data.length > 0) {
                const subList = JSON.parse(data.data.data[0].Json)
                ...
                setSelectedItems(JSON.parse(data.data.data[0].Json).extra)
                ...
                loading
                    ...
                    <div className="mt-2 flex flex-col">
                        <h1 className="text-2xl font-bold text-gray-900 tracking-tight sm:text-2xl">
                            Report Card {studentCode}, {year}, {catgcode}
                        </h1>
...
export default EditStudentReportCard