    ...
    const fetchUserInfo = async () => {
        ...
        try {
            ...
            if (data.data.data.length > 0) {
                const fetchbasti = JSON.parse(data.data.data[0].Json).basti_name
                // const bastimatch = parsedData.find((b) => b.basti_name === fetchbasti)
                console.log(JSON.parse(data.data.data[0].Json).stubasti, "bastimatch");
                setSelectedBasti(JSON.parse(data.data.data[0].Json).stubasti)
                                    ...
                                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                        ...
                                        <div className="sm:col-span-3">
                                            <label htmlFor="first-name" className="block text-sm font-medium leading-6 text-gray-900">
                                                State
                                                {console.log(selectedBasti, "dsdsddsdsds")}
                                            </label>
                                            <div className="mt-2">
                                                <input
                                                    type="text"
