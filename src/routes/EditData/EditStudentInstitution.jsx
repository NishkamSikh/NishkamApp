    ...
    const fetchUserInfo = async () => {
        ...
        try {
            ...
            if (data.data.data.length > 0) {
                setInstitutionType(JSON.parse(data.data.data[0].Json).institutiontype);
                setSelectedInstitution(JSON.parse(data.data.data[0].Json).institutionname);
                setboardoruniversity(JSON.parse(data.data.data[0].Json).boardoruniversity);
