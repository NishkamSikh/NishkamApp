...
const DonorProfileEdit = () => {
  ...
  const fetchUserInfo = async () => {
    ...
    setloading(true);
    try {
      const response = await fetch(`https://sikligarapi-fpe3b0bjfhgsadg5.centralindia-01.azurewebsites.net/api/v1/getSingleDonorById/${JSON.parse(searchParams.get('Id'))}`);
      //const response = await fetch(`https://sikligarapi-fpe3b0bjfhgsadg5.centralindia-01.azurewebsites.net/api/v1/getSingleDonorById/${JSON.parse(searchParams.get('Id'))}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`https://sikligarapi-fpe3b0bjfhgsadg5.centralindia-01.azurewebsites.net/api/v1/updateDonorData/${JSON.parse(searchParams.get('Id'))}`, {
      //const response = await fetch(`https://sikligarapi-fpe3b0bjfhgsadg5.centralindia-01.azurewebsites.net/api/v1/updateDonorData/${JSON.parse(searchParams.get('Id'))}`, {
