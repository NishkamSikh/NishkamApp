...
const Login = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        const response = await fetch("https://sikligarapi-fpe3b0bjfhgsadg5.centralindia-01.azurewebsites.net/api/v1/login", {
            method: 'POST',
            headers: {
        ...
        if (json.Userrole === 'user' || json.Userrole === 'admin') {
            ...
            const permissionsResponse = await fetch('https://sikligarapi-fpe3b0bjfhgsadg5.centralindia-01.azurewebsites.net/api/v1/getUserPermissions', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
